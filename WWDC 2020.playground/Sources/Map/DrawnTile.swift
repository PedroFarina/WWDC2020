...
public class DrawnTile {
    ...
    public static let upEdgeDefinition = SKTileDefinition(texture: SKTexture(imageNamed: "Tiles/Up.png"))
    private static let upEdgeRule = SKTileGroupRule(adjacency: .adjacencyUpEdge,
                                     tileDefinitions: [ upEdgeDefinition ])

    public static let downEdgeDefinition = SKTileDefinition(texture: SKTexture(imageNamed: "Tiles/Down.png"))
    private static let downEdgeRule = SKTileGroupRule(adjacency: .adjacencyDownEdge,
                                       tileDefinitions: [ downEdgeDefinition ])

    public static let leftEdgeDefinition = SKTileDefinition(texture: SKTexture(imageNamed: "Tiles/Left.png"))
    private static let leftEdgeRule = SKTileGroupRule(adjacency: .adjacencyLeftEdge,
                                                      tileDefinitions: [ leftEdgeDefinition ])

    public static let rightEdgeDefinition = SKTileDefinition(texture: SKTexture(imageNamed: "Tiles/Right.png"))
    ...
    public static let upLeftEdgeDefinition = SKTileDefinition(texture: SKTexture(imageNamed: "Tiles/UpLeft.png"))
    private static let upLeftEdgeRule = SKTileGroupRule(adjacency: .adjacencyUpperLeftEdge,
                                                    tileDefinitions: [ upLeftEdgeDefinition ])

    public static let upRightEdgeDefinition = SKTileDefinition(texture: SKTexture(imageNamed: "Tiles/UpRight.png"))
    ...
    public static let downLeftDefinition = SKTileDefinition(texture: SKTexture(imageNamed: "Tiles/DownLeft.png"))
    private static let downLeftEdgeRule = SKTileGroupRule(adjacency: .adjacencyLowerLeftEdge,
                                                      tileDefinitions: [ downLeftDefinition ])

    public static let downRightDefinition = SKTileDefinition(texture: SKTexture(imageNamed: "Tiles/DownRight.png"))
    ...
    //MARK: Interiors
    public static let upLeftInteriorDefinition = SKTileDefinition(texture: SKTexture(imageNamed: "Tiles/UpLeft Interior.png"))
    ...
    public static let upRightInteriorDefinition = SKTileDefinition(texture: SKTexture(imageNamed: "Tiles/UpRight Interior.png"))
    ...
    public static let downLeftInteriorDefinition = SKTileDefinition(texture: SKTexture(imageNamed: "Tiles/DownLeft Interior.png"))
    ...
    public static let downRightInteriorDefinition = SKTileDefinition(texture: SKTexture(imageNamed: "Tiles/DownRight Interior.png"))
